...
/** Pulls in the block attributes that are set in the block.json file and edit.js script. Applies attributes to the block wrapper element and render on the front-end.
 */
...
<div <?php echo $block_wrapper_attributes; ?>>
    ...
    <div class="curve top-curve"
        style="display: <? echo $attributes['enableTopCurve'] ? "block" : "none" ?>; z-index: 0; transform: <? echo $topTransform; ?>; height: <? echo $attributes['topHeight'] ?>px;">
